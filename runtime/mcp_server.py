...
def handle_tool_call(name: str, arguments: dict) -> str:
    ...
    # --- Pipeline ---
    if name == "harmony_pipeline_start":
    ...
    if name == "harmony_pipeline_respond":
    ...
    # --- Template ---
    if name == "harmony_generate_template":
    ...
    # --- Checkpoint ---
    if name == "harmony_checkpoint_save":
